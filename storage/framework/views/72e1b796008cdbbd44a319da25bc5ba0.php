                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown"
                        ...
                        <span class="d-flex align-items-center">
                            <?php
                            $avatarUrl = Auth::check() && Auth::user()->avatar ? URL::asset('images/' .
                            Auth::user()->avatar) : URL::asset('build/images/users/avatar-1.jpg');
                            ?>

                            <img class="rounded-circle header-profile-user" src="<?php echo e($avatarUrl); ?>" alt="Header Avatar">
                            ...
                            <span class="text-start ms-xl-2">
                                ...
                                <span
                                    class="d-none d-xl-inline-block ms-1 fw-medium user-name-text"><?php echo e($userName); ?></span>
...
</div><!-- /.modal --><?php /**PATH D:\baseLaravel-v10\resources\views/layouts/topbar.blade.php ENDPATH**/ ?>